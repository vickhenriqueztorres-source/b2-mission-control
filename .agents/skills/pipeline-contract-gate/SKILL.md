...
1. **Zero Telas Pretas / Zero Ghosting:** Toda cena deve possuir mídia válida garantida:
   - Start Frame autêntico gerado por IA (`firefly_start_frame.png` >10 KB) E
   - Vídeo Take (`firefly_take.mp4` >50 KB, local ou do Repositório Central) OU Animação Procedural 2.5D (Dossiê/Paralaxe Remotion).
