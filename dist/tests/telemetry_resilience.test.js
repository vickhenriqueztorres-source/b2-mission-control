...
async function testTelemetryResilience() {
    ...
    await new Promise((resolve, reject) => {
        const ws = new ws_1.default('ws://localhost:3333');
    ...
    const jsonlPath = path_1.default.resolve(`C:/B2-AI-STUDIO/mission-control/runs/${testRunId}/events.jsonl`);
    if (!fs_1.default.existsSync(jsonlPath)) {
        throw new Error('Arquivo JSONL da execução não foi criado.');
    }
    const jsonlLines = fs_1.default.readFileSync(jsonlPath, 'utf-8').trim().split('\n');
