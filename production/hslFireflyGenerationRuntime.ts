  ...
  prepare(handoffs: readonly HslGenerationHandoff[], outputDirectory: string): HslFireflyPreparedBatch {
    ...
    for (const handoff of handoffs) {
      ...
      items.push({
        ...
        model: item.model, resolution: targetResolution, aspect_ratio: item.aspect_ratio,
    ...
    fs.writeFileSync(masterGuidePath, `${JSON.stringify({
      schema: 'hsl.firefly.multi-provider-guide.v2', model: 'Kling 3.0', resolution: targetResolution,
