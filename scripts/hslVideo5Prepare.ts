...
import {HSL_VIDEO_5_EPISODE_SEED} from '../hsl/editorial/config/video5EpisodeSeed';
...
async function main(): Promise<void> {
  process.env.HSL_NARRATION_WPM = process.env.HSL_VIDEO_5_NARRATION_WPM || '157.7';
  process.env.HSL_VISUAL_CADENCE_SECONDS = process.env.HSL_VISUAL_CADENCE_SECONDS || '5.9';
  process.env.HSL_GENERATED_SHOTS_PER_SCENE = process.env.HSL_GENERATED_SHOTS_PER_SCENE || '3';
  process.env.HSL_PREMIUM_MOTION_SHOTS = process.env.HSL_PREMIUM_MOTION_SHOTS || 'HSL5_001_V03,HSL5_004_V03,HSL5_007_V03,HSL5_011_V03,HSL5_015_V03,HSL5_019_V03';
  ...
  process.stdout.write(`${JSON.stringify({
    status: 'VIDEO_5_PREPRODUCTION_READY',
